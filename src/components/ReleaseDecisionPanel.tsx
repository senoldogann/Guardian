...
function DecisionIcon({ decision }: { decision: ReleaseDecisionStatus }): ReactElement {
  ...
  if (decision === "PASS_WITH_WARNING") return <ShieldAlert className="w-4 h-4 text-amber-300" />;
    ...
    <div className="guardian-elevated-card rounded-2xl p-4 space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        <label className="text-[10px] text-text-muted uppercase tracking-widest">
          ...
          <input
            className="guardian-focus-ring mt-1 w-full rounded-lg border border-border-main bg-background/40 px-3 py-2 text-xs outline-none"
            value={approver}
      ...
      <div className="flex flex-wrap gap-2">
        <select
          ...
          className="guardian-focus-ring rounded-lg border border-border-main bg-background/60 px-3 py-2 text-[10px] font-bold uppercase tracking-widest"
        >
      ...
      {needsOverride && (
        <div className="rounded-xl border p-3 space-y-2 border-[color:var(--tone-critical-border)] bg-[color:var(--tone-critical-bg)]">
          ...
          <input
            className="guardian-focus-ring w-full rounded-lg border border-[color:var(--tone-critical-border)] bg-background/55 px-3 py-2 text-xs outline-none text-text-main"
          ...
          <button
            ...
            className={clsx(
              "guardian-focus-ring px-3 py-2 rounded-lg text-[10px] font-bold uppercase tracking-widest border transition-colors cursor-pointer",
              "bg-background/65 text-[color:var(--tone-critical-text)] border-[color:var(--tone-critical-border)] hover:bg-[color:var(--tone-critical-bg)]",
