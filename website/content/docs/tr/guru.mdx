---
title: "Guru: Release Decision Asistanı"
summary: "AI-generated kod risklerini açıklamak ve insan onaylı release kararını desteklemek için Guru'yu kullanın."
section: "Özellikler"
order: 3
---
...
Guru, Guardian'ın **release öncesi AI-generated code control** odaklı yerleşik asistanıdır. Riskli değişiklikleri açıklar, fix önerir ve insan onay/override kararını destekler.

### Temel özellikler

| Özellik | Açıklama |
|---------|----------|
| **Risk açıklaması** | Bir değişikliğin release riski nedenini anlatır |
| **Policy uyumlu yönlendirme** | Mimari/güvenlik/kalite policy'lerine göre öneri verir |
| **Fix önerileri** | Uygulanabilir kod değişiklikleri üretir |
| **Human approval context** | Approver için karar gerekçesi oluşturur |

## Release decision akışı

Guru'yu generic copilot gibi değil, şu akışla kullanın:

1. AI-assisted veya şüpheli büyük refactor değişikliği analiz et.
2. Policy riskini ve fix önerisini netleştir.
3. Human approval veya override reason kaydet.
4. "Bu kod release'e çıkabilir mi?" sorusunu cevapla.
