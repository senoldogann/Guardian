---
title: "Yapılandırma"
summary: "AI-generated code control için policy, gate ve approval ayarlarını yönetin."
...
Guardian yapılandırması tek hedefe odaklanır: **AI-generated code'u release öncesi kontrol etmek**. Bu sayfa policy, gate ve runtime ayarlarını özetler.

## Policy tek kaynak doğrusu

Guardian, repo kökündeki version-controlled policy dosyasını kullanır:

```yaml
guardian.policy.yaml
```

Minimum gate alanları:

- `schema_version`
- `packs[]`
- `gate.pass_max_warnings`
- `gate.block_on_critical`
- `gate.require_human_approval_on_ai_heavy`
- `gate.require_override_reason`

Desktop, CLI ve CI release kararları için bu dosyayı tek source of truth kabul edin.
