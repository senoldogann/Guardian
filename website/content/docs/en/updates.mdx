...
├── Guardian_1.2.3_aarch64.app.tar.gz   # macOS updater artifact
├── Guardian_1.2.3_aarch64.dmg          # macOS installer
└── ...
```
...
```json
{
  ...
  "platforms": {
    "darwin-aarch64": {
      ...
      "url": "https://github.com/<org>/<repo>/releases/download/v1.2.3/Guardian_1.2.3_aarch64.app.tar.gz"
    }
  }
}
```
