---
title: "Updates"
summary: "In-app update flow, release trust chain, and operational behavior for governance-safe upgrades."
section: "Operations"
order: 3
---
...
Guardian checks for updates on startup, on focus, and every 15 minutes while the app is open. Reliable updates matter because release decisions must run on trusted binaries. When an update is available you can install it from the update banner or **Settings > Updates**.
