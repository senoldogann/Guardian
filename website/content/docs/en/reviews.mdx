...
summary: "Manage suggested fixes with human approval, override accountability, and release decision traceability."
section: "Features"
order: 4
---
...
Reviews & Fix Proposals are the human-approval stage of Guardian's release governance flow. You preview and apply fixes in a controlled queue, then record the release decision outcome with approver context.

Guardian reads proposals from your workspace at:
...
Release decisions and overrides are recorded separately at:
...
5. Record or review release decision state (`PASS`, `PASS_WITH_WARNING`, `BLOCK_UNTIL_APPROVED`, `OVERRIDDEN`)
