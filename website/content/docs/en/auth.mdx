...
| **OpenAI** | GPT models (gpt-5.2, gpt-5.3) | General purpose, fast responses |
| **Anthropic** | Claude models (claude-sonnet-4.5, claude-haiku) | Deep code analysis, security review |
| **Google Gemini** | Gemini models (gemini-3.0-flash, gemini-3-pro) | High speed, multimodal |
| **GitHub Models** | GitHub-hosted AI models | GitHub ecosystem integration |
...
4. **GitHub Models**: Visit [github.com/marketplace/models](https://github.com/marketplace/models)
...
| **Linux** | Secret Service API | AES-256 |
