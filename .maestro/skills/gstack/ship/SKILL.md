...
1. Read `.maestro/skills/review/checklist.md`. If it is unavailable, fall back to `.agent/skills/review/checklist.md`, then `.claude/skills/review/checklist.md`. If none of those files can be read, **STOP** and report the error.
