...
Read `.maestro/skills/review/checklist.md`.

If that path is unavailable, fall back to `.agent/skills/review/checklist.md`, then `.claude/skills/review/checklist.md`.

**If neither file can be read, STOP and report the error.** Do not proceed without the checklist.
