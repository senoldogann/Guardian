...
Shared source lives in `.maestro/skills/`, and selected providers expose the same skills through their own bridge directories such as `.agent/skills/`, `.claude/skills/`, or `.agents/skills/`.
